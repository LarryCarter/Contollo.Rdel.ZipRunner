...
namespace Contollo.Rdel.ZipRunner.AI.Providers
{
    internal sealed class MemoryProvider : IContextProvider
    {
        ...
        public ContextSection Build(ContextAssemblyRequest request) { return new ContextSection("Project Memory", ProviderText.ReadDocument(request.SolutionRoot, "docs/memory.md", 5000)); }
    }
}
